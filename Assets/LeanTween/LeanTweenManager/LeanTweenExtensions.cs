...
public static class LeanTweenExtensions
{
    ...
    /// <returns> Returns the ID of the tween<returns>
    public static int MoveFrom(RectTransform transform, Vector3 fromPosition, float time)
    {
        ...
        LTDescr descr = LeanTween.move(transform, toPosition, time);
        return descr.id;
    }
    ...
    {
        Vector3 toPosition = new Vector3(transform.anchoredPosition.x, transform.anchoredPosition.y, 0);

        float posY = (Screen.height + transform.rect.height);
        Vector3 offScreenPosition = new Vector3(transform.anchoredPosition.x, posY, 0);
    ...
    {
        float posY = (Screen.height + transform.rect.height);
        Vector3 toPosition = new Vector3(transform.anchoredPosition.x, posY, 0);
    ...
    {
        float posX = -(Screen.width + transform.rect.width);
        Vector3 toPosition = new Vector3(posX, transform.anchoredPosition.y, transform.localPosition.z);
